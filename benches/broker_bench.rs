...
use mt_mqtt::protocol::{
    definitions::ControlPacketType,
    frame::{ControlPacket, Frame},
    packet::*,
};
...
fn create_publish_frame(topic: &str, payload: &[u8], qos: u8, retain: bool) -> Frame {
    ...
    Frame {
        fix_header: FixHeader::new(ControlPacketType::PUBLISH, Flags(if retain { 1 } else { 0 }, qos, 0, 0)),
